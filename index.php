				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h2 class="alt">Thinking about selling <span class="blackblock"> 3321 Morcom Ave? </span> Let us help! This is YOUR personal team of professionals. Whether you have questions about purchasing or selling, you can rest assured when you have your own Team of Fast Agents backing you.</h2>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							...
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 3321 Morcom Ave</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>3381 Morcom Ave</strong></h3>
										<ul>
											<li>3 Bed - 1 Bath</li>
											<li>1,490 Sq Ft - 4,788 Lot</li>
											<li>List: 7/14/13 - Pending: 8/10/13</li>
											<li>List: $452,000 - SOLD $460,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>3014 Morcom Ave</strong></h3>
										<ul>
											<li>2 Bed - 1 Bath</li>
											<li>1,048 Sq Ft - 4,403 Lot</li>
											<li>List: 7/17/13 - Pending: 8/2/13</li>
											<li>List: $300,000 - SOLD $350,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>2712 Rawson St</strong></h3>
										<ul>
											<li>3 Bed - 1 Bath</li>
											<li>1,148 Sq Ft - 4,387 Lot</li>
											<li>List: 7/18/13 - Pending: 7/31/13</li>
											<li>List: $448,168 - SOLD $460,000</li>
										</ul>
									</article>
								</div>
							</div>
